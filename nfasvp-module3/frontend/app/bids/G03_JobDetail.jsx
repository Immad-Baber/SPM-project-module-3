          ...
          <div style={{ maxWidth: 1200, padding: 24, display: "grid", gridTemplateColumns: "1fr 368px", gap: 24, alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <span onClick={() => onNavigate("browse")} style={{ fontSize: 12, color: "#747780", cursor: "pointer", fontWeight: 500, textDecoration: "underline" }}>Browse Jobs</span>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 11, fontWeight: 600, color: C.navy, fontFamily: "'Inter', sans-serif" }}>15 submitted</div>
                  </div>
                </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20, position: "sticky", top: 20 }}>
              ...
              <SectionCard style={{ borderRadius: 12 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  ...
                  <Btn variant="ghost" style={{ width: "100%", height: 36, justifyContent: "center", fontSize: 12 }} onClick={() => onNavigate("browse")}>
                    ← Back to Jobs
                  </Btn>
                </div>
              </SectionCard>
